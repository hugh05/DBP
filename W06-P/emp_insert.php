<?php
    ...
    $query_next_end_no = mysqli_query($link, "SELECT emp_no FROM employees ORDER BY emp_no DESC LIMIT 1");
    $emp_next_end_no = mysqli_fetch_array($query_next_end_no)['emp_no'] + 1;
?>
...
<body>
    <h2><a href="index.php">직원 관리 시스템 | 신규 직원 등록</a></h2>
    <form action="emp_insert_process.php" method="POST">
        <label>emp_no: </label>
        <input type="text" name="emp_no" value="<?=$emp_next_end_no?>" placeholder="emp_no"><br>
